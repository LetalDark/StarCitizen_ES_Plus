...
25. **Daño real en granadas** (v1.29.6): las granadas letales muestran su daño en la descripción, junto al tipo de daño — la MK-4 con el valor actual de cada canal (buff de 4.9 incluido en PTU), y la granada de plasma Scorch estrena el daño real de su zona de peligro persistente ("Daño total: 250 (25/s) | Radio: 4.25m") en lugar del daño simbólico de su impacto
