...
24. **Correcciones de precisión** (v1.29.4): los ocultadores de fogonazo y supresores muestran su supresión total del fogonazo ("Fogonazo: -100%" — el juego omite este dato); la lista de "Posibles Planos" solo aparece en las misiones que de verdad dan planos (las misiones Covalex de rango bajo mostraban las recompensas del rango superior sin darlas — reporte de la comunidad); 11 nombres de accesorios corregidos (las miras Behr recuperan su nombre oficial EE04/EE08, ediciones "Tweaker" reordenadas, restos sin traducir)
