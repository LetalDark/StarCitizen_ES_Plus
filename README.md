...
**Total: 90 343 claves en LIVE (4.9.0 "Frontier Tensions", build 12344265) + 90 513 claves en PTU (4.10.0 "Siege of Orison", build 12368639). Parche 4.9.0 completo en español y el nuevo ciclo 4.10 traducido desde su primer parche de pruebas: arco de misiones de Recco Battaglia en Nyx, sets de armadura Stronghold y Ultimatum, y más**
